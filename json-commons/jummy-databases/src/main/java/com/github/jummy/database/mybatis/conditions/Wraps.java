package com.github.jummy.database.mybatis.conditions;

import com.github.jummy.database.mybatis.conditions.query.LbqWrapper;
import com.github.jummy.database.mybatis.conditions.update.LbuWrapper;

/**
 * @author: jummy
 * @create_date: 14/09/2021 10:54 上午
 * @desc:
 */
public class Wraps {
    private Wraps() {
